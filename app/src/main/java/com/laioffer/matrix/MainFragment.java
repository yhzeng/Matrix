...
//            }.execute();
    ...
    private void setupBottomBehavior() {
        ...
        mEventImageLike = (ImageView) nestedScrollView.findViewById(R.id.event_info_like_img);
        mEventImageComment = (ImageView) nestedScrollView.findViewById(R.id.event_info_comment_img);
        mEventImageType = (ImageView) nestedScrollView.findViewById(R.id.event_info_type_img);
        mEventTextLike = (TextView) nestedScrollView.findViewById(R.id.event_info_like_text);
        mEventTextType = (TextView) nestedScrollView.findViewById(R.id.event_info_type_text);
        mEventTextLocation = (TextView) nestedScrollView.findViewById(R.id.event_info_location_text);
        mEventTextTime = (TextView) nestedScrollView.findViewById(R.id.event_info_time_text);
